  ...
  <div class="card mb-4">
    ...
    <?php $n =1;  foreach ($courseArrayNext as $courseDetailsNext) { ?>
          ...
          <div class="card p-2 h-100 shadow-none border">
            ...
            <div class="rounded-2 text-center mb-3">
              <a href="#"><img class="img-fluid" src="https://gfa-tech.com/portal/uploads/files/<?=$courseDetailsNext['img']?>" alt="course image" /></a>
            </div>
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-3">
...
<?php 
    ...
    <?php $n =1;  foreach ($courseArrayUpcoming as $courseDetails) { ?>
        ...
        <!-- <a class="h5" href="#">Upcoming Course</a> -->
            <div class="rounded-2 text-center mb-3">
              <a href="#"><img class="img-fluid" src="https://gfa-tech.com/portal/uploads/files/<?=$courseDetails['img']?>" alt="course image" /></a>
            </div>
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-3">
