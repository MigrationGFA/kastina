...
<!--   The investor name & title -->
            ...
            <h4 class="card-title">Started Learning [APPLICANTS] <?php //echo $this->encrypt->decode($this->session->userdata('cor_info')) ; ?> </h4>
 ...
 <?php 
    ...
    <div class="col-lg-12 col-12">
        <div class="col-lg-12 text-center mb-2">
            <a href="<?php echo base_url(); ?>gfa/export_started_learnining" class="btn btn-secondary btn-next" style="margin:5px;"> Export Data </a> 
...
<div class="card card-company-table">
        ...
        <?php         
           ...
           $row  = $this->gfa_model->ExportWemaEkitiStartedLearning('KATSINA ALAT');
