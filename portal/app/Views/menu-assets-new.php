...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo ">
     ...
     <img src='<?=base_url('public/assets/images/katsina_logo.jpeg')?>' style='width: auto; height: 65px;'>
    </a>
  </div>
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- <li class="menu-item <?php echo ($cohort == '4') ? '' : 'd-none'; ?>">
      <a href="<?php echo base_url('gfa/pre_courses'); ?>" class="menu-link">
        ...
        <div data-i18n="Pre-Courses">Pre-Courses </div>
      </a>
    </li> -->
    <!-- <li class="menu-item <?php echo ($cohort < 3) ? '' : 'd-none'; ?>">
    ...
    <li class="menu-item">
      ...
      <?php      
      	$this->gfa_model->GetCertificateEligibleSoftSkills($email)[0]['Score'] >=60
      	// $this->gfa_model->GetQuizCertificateEligibleSoftSkills($email)[0]['Score'] >=60
      ?>
    <!-- <li class="menu-item <?php echo ($this->gfa_model->GetCertificateEligibleSoftSkills($email)[0]['Score'] >=60) ? '' : 'd-none'; ?>">
    ...
    <?php  //if($count++ == 5){ break; } }  }  ?>    
      ...
      <!-- <li class="menu-item <?php echo ($cohort < 3) ? '' : 'd-none'; ?>">
      <a href="<?php echo base_url('gfa/profilestartup'); ?>" class="menu-link">
        <i class="menu-icon tf-icons ti ti-book"></i>
        <div data-i18n="Update Course">Update Course</div>
      </a>
    </li> -->
    <!-- <li class="menu-item">
      <a href="<?php echo base_url('chat/index'); ?>" class="menu-link">
        <i class="menu-icon tf-icons ti ti-messages"></i>
        <div data-i18n="Chat">Community Chat</div>
      </a>
    </li> -->
    <li class="menu-item">
